...
- [x] Создать/обновить файл `tests/loader/test_codemanifest.py` — интеграционный тест с реальной файловой системой
...
- [x] Обновить файл `tests/server/test_server.py` — интеграционный тест через HTTP
...
- [x] Обновить файл `tests/frontend/test_index_page.py` — интеграционный тест HTML
...
- [x] Запустить валидацию: `python -m pytest tests/ -x`
...
- [x] Интеграционные тесты существуют там, где межсущностные сценарии их требуют
